...
public class SAPNetweaverGateway {
    ...
    public String getCustomerDetails(String requestData) throws Exception {
        ...
        try {
            ...
            if (customerDetailsBapi.getReturnData() != null && customerDetailsBapi.getReturnData().containsKey("NUMBER")) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String customerData = "{\"customerNo\": \"0004145672\",\"companyCode\": \"MVPL\"}";
        ...
        System.out.println(sapNetweaverGateway.getCustomerDetails(customerData));
    }
}
